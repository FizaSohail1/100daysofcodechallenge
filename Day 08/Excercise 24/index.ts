...
let stringEqualityTest: string = "hello"
...
// Srep 2: Testing by using lower case function
  const lowerCaseTest: string = "HELLO"
...
const numericalEqualityTest:number = 5 ;
console.log("\n If numericalEqualitytest ==5,I predict it true")
  ...
  const lessThanOrEqualTest: number = 10; 
...
const andOperatorTest: string = "true"; 
...
const oroperetertest: string = "true"
...
const itemInArrayTest: Array<number>=[1,2,3,4,5];
